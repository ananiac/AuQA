...
## Mutation changeCxConfigsTabModuleFieldValues
#configWriteMutation
...
#
## Mutation setRackPointSensorTemperature
#pointWriteMutation
#    [Arguments]    ${oid}    ${temp}
...
## Mutation setHighAndLowSetPointValues
...
#    return from keyword    ${mutation}
#
## Mutation - changeGroupPropertiesParameterValue
...
## Mutation - writeUserEventsEntryToNotificationEventLog
