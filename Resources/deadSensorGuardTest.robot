...
Library    JSONLibrary
Library    Collections
Resource    ../Resources/deadSensorGuardResources.robot
Variables   ../Inputs/deadSensorGuardInputs.py
...
Cleanup
    ...
    deadSensorGuardResources.setGroupPropertiesForDeadSensorTest    ${sadc_oid}    ${control_dead_densor_threshold_cleanup_value}    ${alarm_dead_sensor_hysteresis_cleanup_value}    ${alarm_dead_sensor_threshold_cleanup_value}
    #18)Exit test
