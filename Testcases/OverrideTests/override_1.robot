...
SFCMinMaxCheck
    ...
    apiresources.setTemperatureForAllRacksRATandDATSensorPointsEveryMinute    66    68    53
    #18)Go to CX > Tools > Configs
    #19)Set Configs > System::SFCMin = 72% and SFCMax = 88%
    override1TestResources.setConfigSFCMinAndSFCMaxValues    72    88
    #20)Wait 3 minutes
    ...
    uiresources.overrideNamedAHUWithSpecifiedBOPAndSFCValuesFromUI  CAC_10  ON  77
    #24)Verify On/Off Override = ON
    verifyOverrideValueOfSpecificControlInOverriddenAHU    CAC_10    BOP   1
    #25)Verify On/Off Origin = MANUAL
    verifyOriginOfSpecificControlInOverriddenAHU    CAC_10    BOP   MANUAL
    #26)Verify Supply Fan Override = 77.0% for AHU CAC_10
    verifyOverrideValueOfSpecificControlInOverriddenAHU     CAC_10    SFC    77
    #27)Verify Supply Fan Origin = MANUAL
    verifyOriginOfSpecificControlInOverriddenAHU    CAC_10    SFC    MANUAL
    #28)Wait 4 minutes
    common.waitForMinutes    4
    #29)Verify Supply Fan Value = 77.0% for AHU CAC_10
    verifyValueOfSpecificControlofNamedAHU    CAC_10    SFC    77
    #30)Verify On/Off Value = ON
    verifyValueOfSpecificControlofNamedAHU    CAC_10    BOP    1
