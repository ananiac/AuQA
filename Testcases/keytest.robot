...
#    apiresources.checkSupplyFanValueOfSingleAHUUsingName    CAC_12    97
    ...
    #11.Set config DASHM::NumGuardUnits=1, NumMinutesGuardTimer=1, and SYSTEM::NumMinutesPast=20
    ...
    #13.set all rack temperature sensor points every minute at say 66 F
    apiresources.setCoolingTemperatureForAllSensorPoints    66
    #15.Set Configs > System::SFCMin = 72% and SFCMax = 88%
