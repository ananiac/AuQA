...
#    #21)Wait 2 minutes
    common.waitForMinutes    3
#    #20)Expect all AHU  to go into Mismatch on the Equipment Tab and Failed to Turn OFF alarm is produced
...
#    #n)Set all the AHU PWR to 0.1kW
    apiresources.setTemperatureForAllRacksRATandDATAndPowerForPWRMonitorPointsEveryMinute  ${test_input}[rack_tempF]  ${test_input}[rat_tempF]    ${test_input}[dat_tempF]      ${test_input}[power_monitor_pwr1_kW]
    common.waitForMinutes    3
...
#     #apiresources.queryToFetchJsonResponseAlarmMsgAHUFailToTurOff --not needed here
