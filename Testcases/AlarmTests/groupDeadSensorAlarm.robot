...
GroupDeadSensorAlarmTest
    ...
    #10. Set AHU RAT to 86.2 and DAT to 76.2 and PWR to 10 kW
    ...
    #8. Override all AHUs in NoBindings Group to ON
    ...
    apiresources.checkingAlarmStatusForGroup    ${test_input}[group_dead_sensor_alarm]    ${test_input}[alarm_off]
    ...
    apiresources.checkingAlarmStatusForGroup    ${test_input}[group_dead_sensor_alarm]    ${test_input}[alarm_on]
    ...
    apiresources.writeUserEventsEntryToNotificationEventLog    AuQA test->${group_name}->GroupDeadSensor Alarm Cleared Successfully
