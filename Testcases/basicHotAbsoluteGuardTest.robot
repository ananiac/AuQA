...
BasicHotAbsoluteGuardTest
    ...
    apiresources.setGroupPropertiesGuardHotAbsTempAllowNumExceedencesGuardAndControl    ${basicHotAbsoluteGuardInputs}[allow_num_exceedences_control_default]   ${basicHotAbsoluteGuardInputs}[allow_num_exceedences_guard_default]   ${basicHotAbsoluteGuardInputs}[alm_hot_abs_temp_default]  ${basicHotAbsoluteGuardInputs}[guard_hot_abs_temp_default]
    setPercentDeadSensorThresholdInDASHMConfig    ${basicHotAbsoluteGuardInputs}[percent_deadsensor_threshold_default]
